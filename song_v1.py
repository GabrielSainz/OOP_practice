...
class Album: 
    ...
    Attributes: 
        ...
        artist (Artist): The artist respomsible for the album. 
    ...
    def add_song(self, song, position = None): 
        ...
        Args: 
            ...
            position (optional [int]): If specified, the song will be added to that position 
                ...
                Otherwise, the song will be added to the end of this list.         
        """
...
class Artist: 
    ...
    Attributes: 
        ...
        albums (List[Album]): A list of the albums by this artist. 
            ...
            not an exhaustive list of the artist's publshed albums. 
    ...
    def add_album(self, album): 
        ...
        Args: 
            album (Album): Album object to add to the list. 
                If the album is already present, it wwill not added again (although this is yet to implemented).
        """
    ...
    def add_song(self, name, year, title): 
        ...
        This method will add the song to an album in the collecion 
        A new album will be created in the collection if if doesn't alewady exist. 
...
def create_checkfile(artist_list): 
    """Create a check file from the obkect data for comparison with the original file """
